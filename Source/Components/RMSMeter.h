...
namespace GUI
{
	...
	public:
		...
		VerticalRMSMeter(function<float()>&& valueFunction) : valueSupplier(move(valueFunction))
		{
			startTimerHz(24);
		...
		void resized() override
		{
			...
			gradient = ColourGradient{ Colours::greenyellow, bounds.getBottomLeft(), Colours::red, bounds.getTopLeft(), false };
